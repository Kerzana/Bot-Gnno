...
public class MusicCommand {
    ...
    @Command(name="play",type=ExecutorType.USER, description="Ajoute une Music en liste d'attente.")
    ...
    @Command(name="skip",type=ExecutorType.USER, description="Passe à la music suivante / Deco le Bot")
    ...
    @Command(name="clear",type=ExecutorType.USER, description="Vide la liste d'attente des musiques.")
